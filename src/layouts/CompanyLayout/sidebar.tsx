...
import companyName from '../../assets/images/icons/Logo-writing-white.png';
            ...
            <div className={open ? "menu-item open" : "menu-item"}>
                <div className="menu-option-title" onClick={() => setOpen(!open)}>
                    <span className="icon-title-pair">
                        ...
                        <span className="value text-nowrap">{item.title}</span>
                    </span>
                    <i className="bi bi-caret-down-fill toggle-btn"></i>
                </div>
